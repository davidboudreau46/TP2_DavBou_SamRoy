...
class ActivityChooserModel extends DataSetObservable {
    ...
    private void readHistoricalDataImpl() {
        ...
        r2 = 0;
        r0 = r17;
        r14 = r0.mContext;	 Catch:{ FileNotFoundException -> 0x0022 }
        r0 = r17;
        r15 = r0.mHistoryFileName;	 Catch:{ FileNotFoundException -> 0x0022 }
        r2 = r14.openFileInput(r15);	 Catch:{ FileNotFoundException -> 0x0022 }
        r7 = android.util.Xml.newPullParser();	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r14 = "UTF-8";
        r7.setInput(r2, r14);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r11 = 0;
    L_0x0017:
        r14 = 1;
        if (r11 == r14) goto L_0x0024;
    L_0x001a:
        r14 = 2;
        if (r11 == r14) goto L_0x0024;
    L_0x001d:
        r11 = r7.next();	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        goto L_0x0017;
    L_0x0022:
        r3 = move-exception;
    L_0x0023:
    ...
    L_0x0024:
        ...
        r15 = r7.getName();	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r14 = r14.equals(r15);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        if (r14 != 0) goto L_0x005f;
    L_0x0030:
        r14 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r15 = "Share records file does not start with historical-records tag.";
        r14.<init>(r15);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        throw r14;	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
    L_0x0038:
        r13 = move-exception;
        r14 = LOG_TAG;	 Catch:{ all -> 0x00de }
        ...
        r0 = r17;
        r0 = r0.mHistoryFileName;	 Catch:{ all -> 0x00de }
        r16 = r0;
        r15 = r15.append(r16);	 Catch:{ all -> 0x00de }
        r15 = r15.toString();	 Catch:{ all -> 0x00de }
        android.util.Log.e(r14, r15, r13);	 Catch:{ all -> 0x00de }
    ...
    L_0x005f:
        r0 = r17;
        r4 = r0.mHistoricalRecords;	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r4.clear();	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
    L_0x0066:
        r11 = r7.next();	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r14 = 1;
    ...
    L_0x0078:
        ...
        if (r11 == r14) goto L_0x0066;
    L_0x007b:
        r6 = r7.getName();	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r14 = "historical-record";
        r14 = r14.equals(r6);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
    ...
    L_0x008f:
        ...
        r15 = r15.append(r16);	 Catch:{ all -> 0x00de }
        r15 = r15.toString();	 Catch:{ all -> 0x00de }
        android.util.Log.e(r14, r15, r5);	 Catch:{ all -> 0x00de }
        if (r2 == 0) goto L_0x0023;
    L_0x00b0:
    ...
    L_0x00b8:
        r14 = 0;
        r15 = "activity";
        r1 = r7.getAttributeValue(r14, r15);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r14 = 0;
        r15 = "time";
        r14 = r7.getAttributeValue(r14, r15);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r9 = java.lang.Long.parseLong(r14);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r14 = 0;
        r15 = "weight";
        r14 = r7.getAttributeValue(r14, r15);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r12 = java.lang.Float.parseFloat(r14);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r8 = new android.support.v7.widget.ActivityChooserModel$HistoricalRecord;	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r8.<init>(r1, r9, r12);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        r4.add(r8);	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x008f }
        goto L_0x0066;
    L_0x00de:
        r14 = move-exception;
