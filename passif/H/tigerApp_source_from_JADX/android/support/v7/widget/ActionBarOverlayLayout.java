...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02231 extends ViewPropertyAnimatorListenerAdapter {
        C02231() {
        }
    ...
    static {
        ATTRS = new int[]{C0138R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02231();
        this.mRemoveActionBarHideOffset = new C01412();
        this.mAddActionBarHideOffset = new C01423();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0138R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0138R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0138R.id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, ExploreByTouchHelper.INVALID_ID, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
