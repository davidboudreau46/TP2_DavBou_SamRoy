...
public class ListPopupWindow {
    ...
    class C01552 implements Runnable {
        C01552() {
        }
    ...
    class C01563 implements OnItemSelectedListener {
        C01563() {
        }
    ...
    class C02131 extends ForwardingListener {
        C02131(View x0) {
            super(x0);
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0138R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context) {
        this(context, null, C0138R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0138R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0138R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0138R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0138R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0174R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case C0174R.styleable.Toolbar_navigationIcon /*20*/:
                        case C0174R.styleable.Toolbar_titleTextColor /*23*/:
                        case C0174R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*66*/:
                            return true;
                    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01552();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01563());
            ...
            if (hintView != null) {
                ...
                if (this.mDropDownWidth >= 0) {
                    widthMode = ExploreByTouchHelper.INVALID_ID;
