...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02083 implements ViewPropertyAnimatorUpdateListener {
        C02083() {
        }
    ...
    class C02201 extends ViewPropertyAnimatorListenerAdapter {
        C02201() {
        }
    ...
    class C02212 extends ViewPropertyAnimatorListenerAdapter {
        C02212() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02201();
        this.mShowListener = new C02212();
        this.mUpdateListener = new C02083();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0138R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0138R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0138R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0138R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0138R.styleable.ActionBar, C0138R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0138R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0138R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0138R.attr.actionBarWidgetTheme, outValue, true);
