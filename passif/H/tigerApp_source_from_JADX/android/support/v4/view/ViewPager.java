...
public class ViewPager extends ViewGroup {
    ...
    static class C00861 implements Comparator<ItemInfo> {
        C00861() {
        }
    ...
    static class C00872 implements Interpolator {
        C00872() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01961());
        }
    ...
    class C01954 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00861();
        sInterpolator = new C00872();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00883();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01954());
    }
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0174R.styleable.Toolbar_navigationContentDescription /*21*/:
                return arrowScroll(17);
            case C0174R.styleable.Toolbar_logoDescription /*22*/:
                return arrowScroll(66);
            case C0174R.styleable.AppCompatTheme_popupWindowStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
