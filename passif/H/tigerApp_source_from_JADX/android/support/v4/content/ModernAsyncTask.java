...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00243 extends FutureTask<Result> {
        C00243(Callable x0) {
            super(x0);
        }
    ...
    class C01802 extends WorkerRunnable<Params, Result> {
        C01802() {
            super();
        }
