...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C00392 implements Runnable {
        ...
        C00392(String str, Bundle bundle) {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case C0174R.styleable.Toolbar_contentInsetLeft /*7*/:
    ...
    private class ServiceImpl {
        ...
        class C00401 implements Runnable {
            ...
            C00401(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00412 implements Runnable {
            ...
            C00412(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00423 implements Runnable {
            ...
            C00423(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C00434 implements Runnable {
            ...
            C00434(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C00445 implements Runnable {
            ...
            C00445(String str, ResultReceiver resultReceiver) {
        ...
        class C00456 implements Runnable {
            ...
            C00456(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00467 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;

            C00467(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00401(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00412(callbacks));
        }

        public void addSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00423(callbacks, id, options));
        }

        public void removeSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00434(callbacks, id, options));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00445(mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00456(callbacks));
        }

        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00467(callbacks));
        }
    }

    /* renamed from: android.support.v4.media.MediaBrowserServiceCompat.3 */
    class C01823 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C01823(Object x0, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C01834 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C01834(Object x0, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(x0);
        }
    ...
    private class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class C01841 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            C01841(Handler x0, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String mediaId, ItemCallback cb) {
            this.mServiceImpl.getMediaItem(mediaId, new C01841(MediaBrowserServiceCompat.this.mHandler, cb));
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00381(token));
        }
    }
    ...
    private void notifyChildrenChangedInternal(String parentId, Bundle options) {
        ...
        this.mHandler.post(new C00392(parentId, options));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C01823(parentId, connection, parentId, options);
        if (options == null) {
            onLoadChildren(parentId, result);
        } else {
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C01834(itemId, receiver);
