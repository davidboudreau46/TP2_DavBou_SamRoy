...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00601 implements Creator<QueueItem> {
            C00601() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00611 implements Creator<ResultReceiverWrapper> {
            C00611() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00621 implements Creator<Token> {
            C00621() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0174R.styleable.AppCompatTheme_panelMenuListWidth /*79*/:
                        case C0174R.styleable.AppCompatTheme_colorControlNormal /*85*/:
                            boolean isPlaying;
                        ...
                        case C0174R.styleable.AppCompatTheme_colorControlHighlight /*87*/:
                            if ((32 & validActions) != 0) {
                                cb.onSkipToNext();
                            }
                        case C0174R.styleable.AppCompatTheme_colorButtonNormal /*88*/:
                            if ((16 & validActions) != 0) {
                                cb.onSkipToPrevious();
                            }
                        case C0174R.styleable.AppCompatTheme_colorSwitchThumbNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                            }
        ...
        class C01881 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01881() {
            }
        ...
        class MediaSessionStub extends Stub {
            ...
            public void play() throws RemoteException {
                MediaSessionImplBase.this.postToHandler(MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS);
            }

            public void playFromMediaId(String mediaId, Bundle extras) throws RemoteException {
                MediaSessionImplBase.this.postToHandler(MediaSessionCompat.FLAG_HANDLES_TRANSPORT_CONTROLS, mediaId, extras);
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C01881();
